...
ActiveRecord::Schema.define(version: 2020_01_12_065438) do
  ...
  create_table "contacts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "status_reply", default: 0, null: false
    t.integer "reply_language"
  end
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "status_open", default: 0, null: false
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "accomplish", default: false, null: false
  end
